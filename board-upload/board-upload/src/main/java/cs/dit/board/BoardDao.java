...
public class BoardDao {
	...
	*======================================================================*/
	...
	private Connection getConnection() throws Exception{
		...
		InitialContext initCtx  = new InitialContext();//1. JNDI를 이용하기 위한 객체 생성
		
//		Context envCtx = (Context) initCtx.lookup("java:comp/env");//2. 등록된 네이밍 서비스로부터 등록된 자원을 가져옴	
//		DataSource ds = (DataSource) envCtx.lookup("jdbc/suuurin");//3. 자원들 중 원하는 jdbc/suuurin 자원을 찾아내어 데이터소스를 가져옴
